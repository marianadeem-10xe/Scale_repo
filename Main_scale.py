...
scale = BiLinear_Scale(raw_file, (1536*2, 2592*2))
scaled_img = scale.upscale_bilinear()
...
plt.imsave("./Scaled_img_myCode.png", save_img)
print("image saved")
...
import cv2
cv2_scaled = cv2.resize(raw_file, (2592*2,1536*2), interpolation= cv2.INTER_LINEAR)
print("shape with cv2: ", cv2_scaled.shape)
...
plt.imsave("./Scaled_img_cv2.png", save_img_cv2)
print("image saved")