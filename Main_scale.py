...
GT_path          = "./results/Graph images/rescaled with GIMP/1944x2592_scaled/1.5_scale_fact/"
...
for scale_to_size in [(int(np.round(1944*1.5)), int(np.round(2592*1.5)),3)]:#,(1440, 2560, 3), (720, 1280, 3), (480, 640, 3), (1080,1920, 3)]:
